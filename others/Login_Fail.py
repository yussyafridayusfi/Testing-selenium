...
# def step_impl(context):
#     driver.find_element_by_xpath('//*[@id="username"]').send_keys("first_testing@gmail.com")
...
# @then(u'Fail login')
# def step_impl(context):
#     driver.find_element_by_xpath('//*[@id="wrapper"]/ul/li/div')
#     alert = driver.find_element_by_xpath('//*[@id="wrapper"]/ul/li/div')
#     alert == "Your account has to be activated before you can login. You can resend the email with verification link by clicking "
#     driver.close()